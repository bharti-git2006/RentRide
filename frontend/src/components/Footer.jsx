...
const Footer = () => {
  return (
    <footer className="footer footer-center bg-neutral text-neutral-content p-10 mt-20">
      ...
      <aside>
        ...
        <p className="max-w-md text-neutral-content/70">
          Rent your favorite car quickly, safely, and at affordable prices.
          Experience hassle-free bookings with premium customer support.
        </p>
      ...
      {/* Quick Links */}
      <nav>
        <div className="grid grid-flow-col gap-6 text-sm font-medium">
